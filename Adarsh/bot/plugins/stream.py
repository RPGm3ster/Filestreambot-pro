...
@StreamBot.on_message(
    (filters.regex("login🔑") | filters.command("login")), group=4
)
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [Adarsh Goel](https://github.com/adarsh-goel) He Will Help You**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Something went wrong. Contact my boss** [Adarsh Goel](https://github.com/adarsh-goel)",
                disable_web_page_preview=True)
            return
    try:
